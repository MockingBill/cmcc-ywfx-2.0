var express = require("express"),
    ...
    utils = require("../utils/app_utils"),
    tree = require("../utils/tree_utils"),
    coreService = require("../services/core_service.js"),
    memcached_utils = require("../utils/memcached_utils");
...
router.route("/:code").get(function (a, c) {
    ...
    memcached_utils.getSysParam(a, function (d) {
        memcached_utils.getDict(function (m, g) {
            if (b && 0 == b.menu_type)
                coreService.getPortalPageByCode(b.menu_sysid, p._id, b.menu_url, function (f) {
                if (f.success) {
